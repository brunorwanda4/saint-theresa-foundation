...
export function OpenImages({
	...
	// Call onOpenChange when internal state changes
	...
	return (
		<AlertDialog open={open} onOpenChange={handleOpenChange}>
			...
			<AlertDialogContent className="sm:max-w-screen h-screen p-0 bg-background border-none outline-none">
				{/* Header */}
				<div className="absolute top-0 z-50 left-0 right-0 flex items-center justify-between p-4">
					...
					<div className="flex gap-2">
						<Button variant="ghost" onClick={handleZoomIn} disabled={zoom >= 3}>
							<ZoomIn />
						</Button>
						<Button
							variant="ghost"
