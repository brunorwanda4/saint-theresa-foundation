		...
		<div className="flex flex-col items-end gap-8">
			...
			<div className="flex items-center gap-3">
				<button
					...
					className="w-10 h-10 bg-[#374136]/50 rounded-full flex items-center justify-center hover:bg-[#374136]/70 hover:scale-110 transition-all duration-300 shadow-lg border border-white/10 disabled:opacity-50 disabled:cursor-not-allowed"
