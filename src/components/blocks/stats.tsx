...
function Stats() {
  ...
  const items = [
    ...
    { icon: Calendar, value: `${years}+`, label: "Years serving Rwanda (since 2013)" },
    { icon: Truck, value: "2", label: "Mobile clinic units (by 2026)" },
    { icon: Pill, value: "2", label: "Community pharmacies (by 2026)" },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          {items.map(({ icon: Icon, value, label }) => (
            ...
            >
              ...
              <p className="text-3xl font-bold tracking-tight text-blue-900">{value}</p>
